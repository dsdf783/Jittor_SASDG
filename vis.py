...
from dataset.py3dtojittor import (axis_angle_to_quaternion, quaternion_apply,
                                  quaternion_multiply)
...
class SMPLSkeleton:
    def __init__(
        ...
        self._offsets = jt.array(offsets)
    ...
    def execute(self, rotations, root_positions, expanded_offsets):
        """
        ...
        return jt.stack(positions_world, dim=3).permute(0, 1, 3, 2)